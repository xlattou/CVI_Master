...
//FLASH
	...
	INT16U	Reign_ADC;				// F0H[252~253], 2byte  
	INT8U	Reserved252to255[2];	// F0H[254~255], 2byte 
};
...
extern int EVB5_READ_TINY13_Temper(int EVB5Handle, float *Temper);			//Tiny13 温度读取
...
extern int EVB5_READ_TxIRxI (int EVB5Handle, double *TxI,double *RxI);
...
extern int EVB5_GET_VTR (int inst_EVB5, float *VTR);							//读取模块Vcc电压
