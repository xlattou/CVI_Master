...
extern int DWDM_ONU_DS4830_Set_APC_Auto(int handle); 
extern int DWDM_ONU_DS4830_Set_APC_Manual(int handle); 
extern int DWDM_ONU_DS4830_Set_APC(int handle, unsigned short APC_DAC);
extern int DWDM_ONU_DS4830_Read_APC(int handle, unsigned char* APC_DAC); 	  
...
extern int DWDM_ONU_DS4830_Set_APD(int handle, unsigned char APD_set); 
...
extern int DWDM_ONU_DS4830_Write_APC_Luk(int handle, int address, int value, INT16U wSlop, INT16U wOffset);
extern int DWDM_ONU_DS4830_Read_APC_Luk(int handle, int address, int *value, INT16U *wSlop, INT16U *wOffset);
